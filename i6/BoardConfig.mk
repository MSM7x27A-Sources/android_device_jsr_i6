...
# Kernel
TARGET_KERNEL_SOURCE := kernel/i6
TARGET_KERNEL_CONFIG := i6_defconfig
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom vmalloc=200M androidboot.selinux=disabled hack_lcd=1 chg_hack_lcd=0
